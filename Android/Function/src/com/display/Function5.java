...
public class Function5 extends Activity
{
	static int width;
	static int height;
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        setContentView(R.layout.function5);
        initial();
    }
	...
	public void initial()
	{
        	...
        	public void onClick(View v)
        	{
        		...
        		for(int i=0;i<300;i++)
        		{
            		try
            		{
            			...
            			z[i] = parser.getAnswer(editText3.getText().toString(), leftX + space * i);
            		}
        ...
        backButton.setOnClickListener(new Button.OnClickListener()
        {
        	public void onClick(View v)
        	{
        		...
        		intent.setClass(Function5.this, SelectMain.class);
        		startActivity(intent);
        		Function5.this.finish();
        	}
        });
	}
	...
	public boolean onTouchEvent(MotionEvent event) 
	{
		if(inDisplay)
		{
			this.setContentView(R.layout.function5);
			initial();
