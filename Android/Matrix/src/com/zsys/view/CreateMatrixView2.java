...
public class CreateMatrixView2 extends IView {
	...
	private class ConfirmButtonListener extends ZOnClickListener {
		...
		public void onClick(View v) {
			...
			this.activity.setCurrentView(MainActivity.SCENE_CREATE_CONFIRM, MainActivity.SCENE_STAGE);
		}
	}
	...
	private class BackButtonListener extends ZOnClickListener {
		...
		@Override
		public void onClick(View v) {
			this.activity.setCurrentView(MainActivity.SCENE_CREATE2, MainActivity.SCENE_CREATE1);
		}
	}
	...
	private class CancelButtonListener extends ZOnClickListener {
		...
		@Override
		public void onClick(View v) {
			this.activity.setCurrentView(MainActivity.SCENE_CREATE2, MainActivity.SCENE_STAGE);
		}
	}
